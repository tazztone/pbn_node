...
class RegionSegmenter:
    ...
    def shared_border_segmentation(self, regions: np.ndarray) -> dict[int, list[LineString]]:
        ...
        if np.any(h_adj):
            ...
            for y, x, left_id, right_id in zip(y_coords, x_coords, left_ids, right_ids, strict=False):
        ...
        if np.any(v_adj):
            ...
            for y, x, top_id, bottom_id in zip(y_coords, x_coords, top_ids, bottom_ids, strict=False):
